const traducoes = {
    pt: { 
        menu_home: "Início", menu_about: "Sobre mim", menu_products: "Os meus Projetos", menu_services: "Percurso Académico",
    ...
    en: { 
        menu_home: "Home", menu_about: "About me", menu_products: "My Projects", menu_services: "Academic Background",
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    window.addEventListener('scroll', () => {
        ...
        const rotation = Math.min(scrolled * 0.15, 110);
    ...
    function dragEnd(e) {
        ...
        // 1. DISPARA O SOM PRIMEIRO: antes de qualquer repaint ou mutação de DOM
        tocarSomMagnetico();

        const el = itemAtivo;
        itemAtivo = null;

        // 2. ADIA AS ALTERAÇÕES VISUAIS para a frame seguinte (evita engasgar a thread)
